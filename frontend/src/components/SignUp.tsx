      ...
      <form onSubmit={handleSubmit(registerFunction)} className="flex flex-col justify-evenly items-center border-1 w-full h-full">
        ...
        <div className="w-fit space-y-8 ">
          <div className="flex flex-col gap-2">
            ...
            <input {...register("email", {required:true})} type="email" name="email" className="bg-gray-200 border-b p-2"  autoComplete="off"/>
          </div>
          <div className="flex flex-col gap-2">
            <label htmlFor="password">Contraseña</label>
            <input {...register("password", {required:true})} type="password" name="password" className="bg-gray-200 border-b p-2" autoComplete="off" />
          </div>
          <div className="flex flex-col gap-2">
            <label htmlFor="confirmacion">Confirmar Contraseña</label>
            <input {...register("confirmacion", {required:true})} type="password" name="confirmacion" className="bg-gray-200 border-b p-2" autoComplete="off" />
          </div>
        </div>
